...
public class LessonThreeRenderer extends LessonTwoRenderer
{
	...
	// We have added two linearly-interpolated variables to be passed through to the fragment shader:
	// the vertex position and the vertex normal. Both of these will be used when calculating lighting in the fragment shader.
